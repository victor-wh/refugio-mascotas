...
urlpatterns = [
    ...
    path('personas/listarpfuncion/', persona_list, name='persona_listarfuncion'),
    ...
    path('persona/datallefuncion/<int:id_mascota>/', persona_detail, name='persona_detailfuncion'),
